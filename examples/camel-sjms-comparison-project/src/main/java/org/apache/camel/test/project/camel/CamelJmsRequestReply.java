 ...
 */
package org.apache.camel.test.project.camel;
 ...
 */
public final class CamelJmsRequestReply {

    public static void main(String args[]) throws Exception {
    	new ClassPathXmlApplicationContext("camel-consumer.xml", CamelJmsRequestReply.class);
    	ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("camel-producer.xml", CamelJmsRequestReply.class);
